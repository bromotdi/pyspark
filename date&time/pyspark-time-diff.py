...
dates = [("1","2023-07-01 12:01:19.111"),
    ("2","2023-06-24 12:01:19.222"),
    ("3","2023-11-16 16:44:55.406"),
    ("4","2023-11-16 16:50:59.406")
    ]
...
#SQL
spark.sql("select unix_timestamp('2023-07-02 12:01:19') - unix_timestamp('2019-07-01 12:01:19') DiffInSeconds").show()
spark.sql("select (unix_timestamp('2023-07-02 12:01:19') - unix_timestamp('2019-07-01 12:01:19'))/60 DiffInMinutes").show()
spark.sql("select (unix_timestamp('2023-07-02 12:01:19') - unix_timestamp('2019-07-01 12:01:19'))/3600 DiffInHours").show()
